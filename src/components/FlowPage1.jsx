...
import useAnimeOnInView from "../utils/useAnimeOnInView";
...
export default function PageIntroHero() {
  ...
  const containerRef = useAnimeOnInView({
    targetsSelector: ".animate-fade-up",
    animation: { opacity: [0, 1], translateY: [24, 0], duration: 700, delay: anime.stagger(120) },
  });

  return (
    <div ref={containerRef} className="min-h-screen w-full text-[#1C1C1C] flex flex-col items-center" style={{ background: "transparent" }}>
      {/* Tabs trên cùng */}
    ...
    ĐẾN&nbsp; */}
        ...
        <div className="relative mt-24 flex flex-col gap-16 w-full animate-fade-up">
